     ...
     */
        ...
        public static void count(String[] fileAndWords) throws FileNotFoundException {
            ...
            for (int i = 1; i <= wordCountMap.size(); i++) {
                total += wordCountMap.get(fileAndWords[i].toLowerCase());
            }
            /**
            ...
            if (wordCountMap.size() < 2) {
                if (wordCountMap.get(fileAndWords[1]).intValue() == 1) {
                    System.out.println("The word '" + fileAndWords[1] + "' appears " + wordCountMap.get(fileAndWords[1].toLowerCase()) + " time.");
                } else {
                    System.out.println("The word '" + fileAndWords[1] + "' appears " + wordCountMap.get(fileAndWords[1].toLowerCase()) + " times.");
                }
            } else {
                 ...
                 */
                printBorder(widthOfDisplayColumn, totalRow, countRow);
                /**
                ...
                for (int i = 1; i < fileAndWords.length; i++) {
                    ...
                    System.out.print("|");
                    for (int j = 0; j < countRow.length() - 1 - wordCountMap.get(fileAndWords[i].toLowerCase()).toString().length(); j++) {
                        System.out.print(" ");
                    }
                    System.out.print(wordCountMap.get(fileAndWords[i].toLowerCase()) + " |");
                    System.out.println();
                }
                /**
                ...
                System.out.print("|");
                for (int i = 1; i < countRow.length() - Integer.toString(total).length(); i++) {
                    System.out.print(" ");
                }
         ...
         */
        public static void printBorder(int widthOfDisplayColumn, String totalRow, String countRow) {
            System.out.print("|");
            if (widthOfDisplayColumn < totalRow.length()) {
